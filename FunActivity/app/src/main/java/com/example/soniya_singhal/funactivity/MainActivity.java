...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //tab id
        ...
        mtabLayout.addTab(mtabLayout.newTab().setText("TECHNOLOGIES"));
        mtabLayout.addTab(mtabLayout.newTab().setText("MOVIES"));
        mtabLayout.addTab(mtabLayout.newTab().setText("DESIGN"));
        mtabLayout.addTab(mtabLayout.newTab().setText("POLITICS"));
